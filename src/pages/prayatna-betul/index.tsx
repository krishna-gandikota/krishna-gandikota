...
import styles from './prayatnabetul.module.scss';
        ...
        <section>
                ...
                <div className="flex justify-between min-w-fit bg-[#e0eae6] flex-col lg:flex-row h-auto min-h-[530px] md:min-h-[865px]">
                    <div className="container flex justify-between min-w-fit flex-col lg:flex-row h-auto min-h-[530px] md:min-h-[700px] sm:pt-5">
                        <div className="lg:flex md:flex-row xl:gap-52 lg:gap-0 sm:flex-row justify-center lg:items-center ">
                            ...
                            <div className="flex justify-center flex-col md:flex-col lg:flex-col pt-[70px]  md:pt-0" >
                                {show && (
                                    <div className="bg-white  md:mt-[30px] w-full md:w-full lg:w-[368px] xl:w-[456px] rounded-[8px] p-6 shadow-lg">
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <div className="row-md-6 mb-4">
                                                <label className="block text-[#5A7184] font-sans text-[12px] md:text-[16px]  leading-[21.79px] font-[600] mb-2">Mobile No*</label>
                                                <div className="flex items-center rounded-[8px] h-[56px] outline-none border">
                                                    ...
                                                    <input type="number" placeholder="Enter mobile number" className="w-full text-[#959EAD] font-sans  md:text-[16px] text-[12px] leading-[21.79px] font-[600] py-2 bg-transparent  border-none focus:ring-0 focus:outline-none"
                                                        {...register('number')}
                                                    />
                                            ...
                                            <div className="row-md-6 mb-4">
                                                <div className="form-outline focus:outline-none">
                                                    <label className="block form-label text-[#5A7184] font-sans text-[12px] md:text-[16px]  leading-[21.79px] font-[600] focus:outline-none">
                                                        Email ID*
                                                    </label>
                                                    <input
                                                        type="email"
                                ...
                                <div className={`absolute w-fit sm:top-[240px] md:top-[132px] lg:top-[640px] right-[20px]  lg:right-[37%] ${!show && styles.peopleCentre}`}>
                                    <Image src={"/images/man_help.svg"} width={35} height={30} alt='circle_images' className={`lg:w-[100%] lg:h-[100%] md:w-[48%] w-[25%] ml-auto  mt-[-24rem]  flex justify-center items-center md:hidden ${!show && styles.manhelpImage}`} />
                                    <Image src={"/images/man_help.svg"} width={35} height={30} alt='circle_images' className={`lg:w-[100%] lg:h-[100%] md:w-[48%] w-[68%]  hidden md:flex md:ml-auto md:mt-28 lg:mt-0  ${!show && styles.manhelpImage_Tablet} `} />
            ...
            <div className=' container mx-auto mt-12 '>
                ...
                <div className='flex flex-col '>
                    <h1 className="  text-[#183B56] font-poppins leading-[52px] text-[20px] md:text-[26px] lg:text-[36px]  tracking-[0.2px] font-[700] mb-4">Registration</h1>
                    <p className=" text-[12px] md:text-[14px] lg:text-[18px] text-[#3D3D3D] leading-[22px] md:leading-[32px] ">We regret to inform you that registration for the event has now closed. The overwhelming response from participants has exceeded all expectations, and we are truly grateful for the enthusiastic interest shown in this event.</p>
                </div>
                <div className="flex flex-col sm:flex-row gap-0 sm:gap-10">
                    <button onClick={() => setShow(false)} className=" bg-[#BEBEBF] mb-24 md:text-[16px] flex justify-between items-center h-[56px]  sm:w-[330px] text-white font-bold py-2 px-4 rounded-[8px] outline-none ">
                        <span className="md:ml-6 sm:ml-0 text-[14px] md:text-[16px] lg:text-[18px] uppercase">Registration Closed</span>
                    </button>
                </div>
